...
public class MainTest {
    ...
    public void testInvestmentClassGetInvestmentMethod() {
        ...
        double in_numYears = 6;
        int in_numOfInterestsPerYear = 4;

        Investment investment = new Investment(in_principal, in_interestRate, in_numYears, in_numOfInterestsPerYear);
